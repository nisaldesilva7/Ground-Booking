...
<html lang="en">
      ...
      <div class="container">
        <div class="row no-gutters slider-text d-flex align-itemd-end justify-content-center">
          <div class="col-md-9 ftco-animate text-center d-flex align-items-end justify-content-center">
          	<div class="text">
	            <h1 class="mb-4 bread">BOOKING FAILED!!!!</h1>
            </div>
          </div>
        </div>
      </div>
 ...
 <div class="container">
	...
	<a href="<?php echo base_url('index.php/welcome/ground'); ?>" class="btn btn-primary py-3 px-5">BACK TO GROUNDS</a>
  </br>
  </br>
  <h1>GROUND ALREADY BOOK ON THAT DAY </h1>
