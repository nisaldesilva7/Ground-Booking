        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
          <ul class="navbar-nav ml-auto">
           <li class="nav-item active"><a href="http://localhost/code/" class="nav-link">Home</a></li>
            ...
            <li class="nav-item"><a href="http://localhost/code/index.php/Welcome/adminreg" class="nav-link"><b>REGISTER</b></a></li>
      ...
      <div class="col-sm-9 col-md-7 col-lg-6 mx-auto">
        <div class="card card-signin my-5">
          <div class="card-body">
            ...
            <form method="post" action="<?php echo base_url(); ?>index.php/adminlog_c/login_validation">  
