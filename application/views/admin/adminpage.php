...
<html lang="en">
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
          <ul class="navbar-nav ml-auto">
           <li class="nav-item active"><a href="index.php/ground_c/index" class="nav-link">Home</a></li>
 ...
 <div class="container">
	...
	<a href="<?php echo base_url('index.php/ground_c'); ?>" class="btn btn-primary py-3 px-5">View Grounds</a>
  </br>
  </br>
  <a href="<?php echo base_url('index.php/Welcome/viewbookings'); ?>" class="btn btn-primary py-3 px-5" >View Bookings</a></br>
  </br>

	<a href="<?php echo base_url('index.php/adminlog_c/enter'); ?>" class="btn btn-primary py-3 px-5" >View Feedback comments</a>
