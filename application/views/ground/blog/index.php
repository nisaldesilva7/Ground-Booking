...
<html lang="en">
  <head>
    <title img="assets/images/home/12345.jpg">ACC Ground Booking System(ADMIN)</title>
    <meta charset="utf-8">
  ...
  <body>
    ...
    <div class="hero-wrap" style="background-image:url(<?php echo $this->config->base_url().'assets/images/home/marcus-wallis-473530-unsplash.jpg';?>)">
 ...
 <div class="container">
	...
	<a href="<?php echo base_url('index.php/ground_c/add'); ?>" class="btn btn-primary">Add New Ground</a>
	...
	<table class="table table-bordered table-responsive">
		...
		?>
			<tr>
				...
				<td><?php echo $blog->g_name; ?></td>
				<td><?php echo $blog->g_location; ?></td>
				<td><?php echo $blog->g_size; ?></td>
				<td><?php echo $blog->g_prize; ?></td>
				<td><?php echo $blog->g_light; ?></td>
				<td><?php echo $blog->g_category; ?></td>
				<td><?php echo $blog->g_category; ?></td>
				<td>
					<a href="<?php echo base_url('index.php/ground_c/edit/'.$blog->g_id); ?>" class="btn btn-info">Edit</a>
					<a href="<?php echo base_url('index.php/ground_c/delete/'.$blog->g_id); ?>" class="btn btn-danger" onclick="return confirm('Do you want to delete this record?');">Delete</a>
				</td>
			</tr>
		<?php
				}
